...
export default class App extends React.Component{
  ...
  fetch_weather=()=> {
    fetch('https://api.openweathermap.org/data/2.5/weather?q='+this.state.city+'&APPID=c1c8945552613d83e94a2b28843070c3')
    ...
    <SafeAreaView style={styles.container}>
      ...
      style={styles.Image_Background_Style}>
        ...
        <View style={styles.Search_Box_View}>
          <TextInput placeholder="Nhập tên thành phố" placeholderTextColor="#FFF" style={styles.Search_Box} onChangeText={(text)=>this.setState({city : text})} />
        ...
        <View style={styles.Info_Box_View}>
          <View style={styles.Info_Holder_Veiw}>
            <Text style={styles.Main_Weather_Text}>Thông tin thời tiết</Text>
            <Text style={styles.description_text}>Mô tả :{this.state.desc}</Text>
            <Text style={styles.humidity_text}>Độ ẩm : {this.state.humidity}</Text>
            <Text style={styles.other_text}>Áp xuất không khí : {this.state.pressure}</Text>
            <Text style={styles.other_text}>Tầm nhìn xa : {this.state.visibility}</Text>
          </View>
        </View>
      </ImageBackground>
